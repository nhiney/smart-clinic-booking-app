...
exports.exchangeQrLoginToken = exports.createQrLoginToken = exports.onDoctorApprovedEmail = exports.generateShareToken = exports.versionMedicalRecord = exports.approveDoctorApplication = exports.assignInitialRole = void 0;
 ...
 */
exports.assignInitialRole = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
 ...
 */
exports.approveDoctorApplication = functions.https.onCall(async (data, context) => {
 ...
 */
exports.versionMedicalRecord = functions.firestore
    ...
    await versionRef.set(Object.assign(Object.assign({}, beforeData), { snapshotAt: admin.firestore.FieldValue.serverTimestamp(), snapshotBy: beforeData.updatedBy || 'system' }));
...
exports.generateShareToken = functions.https.onCall(async (data, context) => {
    ...
    if (((_a = recordData === null || recordData === void 0 ? void 0 : recordData.subject) === null || _a === void 0 ? void 0 : _a.reference) !== `Patient/${ownerId}`) {
        throw new functions.https.HttpsError('permission-denied', 'You do not own this record.');
    }
    const grantId = (0, uuid_1.v4)();
    const expiresAt = admin.firestore.Timestamp.fromDate(new Date(Date.now() + durationMinutes * 60000));
 ...
 */
exports.onDoctorApprovedEmail = functions.firestore
 ...
 */
exports.createQrLoginToken = functions.https.onCall(async (_data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Bạn cần đăng nhập để tạo QR.');
    }
    const token = (0, uuid_1.v4)();
    const uid = context.auth.uid;
    const expiresAt = admin.firestore.Timestamp.fromMillis(Date.now() + 60 * 1000);
 ...
 */
exports.exchangeQrLoginToken = functions.https.onCall(async (data, _context) => {
    ...
    const uid = tokenData === null || tokenData === void 0 ? void 0 : tokenData.uid;
    const expiresAt = tokenData === null || tokenData === void 0 ? void 0 : tokenData.expiresAt;
    const status = tokenData === null || tokenData === void 0 ? void 0 : tokenData.status;
    if (!uid || !expiresAt) {
