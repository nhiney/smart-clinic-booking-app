  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (auth.currentUser != null) {
        ref.read(checkInProvider.notifier).generateQR(auth.currentUser!.id, widget.appointmentId);
      }
    });
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Mã này sẽ hết hạn sau: ${state.expiry.difference(DateTime.now()).inMinutes} phút ${state.expiry.difference(DateTime.now()).inSeconds % 60} giây",
