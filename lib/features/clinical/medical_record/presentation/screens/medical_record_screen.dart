...
class _MedicalRecordScreenState extends ConsumerState<MedicalRecordScreen> {
  ...
  static final List<MedicalRecordEntity> _mockRecords = [
    MedicalRecordEntity(
      ...
      diagnosis: 'Đau ngực, tăng huyết áp độ 2 — I20.0 ĐTN không ổn định',
      prescription: '1. Amlodipine 5mg — 1 viên/ngày (sáng)\n'
          '2. Aspirin 81mg — 1 viên/ngày (tối)\n'
          '3. Atorvastatin 20mg — 1 viên/ngày (tối)',
      createdAt: DateTime(2026, 5, 23, 9, 30),
      symptoms: ['Đau ngực lan ra tay trái', 'Khó thở khi gắng sức', 'Hồi hộp'],
      notes: '4 xét nghiệm · Tái khám sau 2 tuần',
    ),
    MedicalRecordEntity(
      id: 'mock0002',
      userId: 'demo',
      doctor: 'BS. Phạm Văn Đức',
      diagnosis: 'Tái khám tăng huyết áp — I10 · THA độ 2',
      prescription: '1. Amlodipine 5mg tiếp tục\n2. Metoprolol 50mg — 1 viên/ngày',
      createdAt: DateTime(2026, 4, 12, 14, 0),
      symptoms: ['Huyết áp cao 165/95 mmHg', 'Đau đầu buổi sáng'],
      notes: 'Đo huyết áp mỗi ngày, ghi nhật ký',
    ),
    MedicalRecordEntity(
      id: 'mock0003',
      userId: 'demo',
      doctor: 'BS. Nguyễn Thị Lan',
      diagnosis: 'Khám sức khoẻ định kỳ — Z00.0 · Khám định kỳ',
      prescription: 'Không có đơn thuốc',
      createdAt: DateTime(2026, 2, 3, 8, 0),
      symptoms: [],
      notes: 'Chỉ số sức khoẻ trong giới hạn bình thường',
    ),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    final records = state.records.isEmpty && !state.isLoading ? _mockRecords : state.records;
