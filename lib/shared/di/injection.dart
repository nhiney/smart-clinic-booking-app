...
import 'package:smart_clinic_booking/features/appointment/data/datasources/appointment_remote_datasource.dart';
import 'package:smart_clinic_booking/features/appointment/data/repositories/appointment_repository_impl.dart';
...
import 'package:smart_clinic_booking/features/appointment/domain/usecases/cancel_appointment_usecase.dart';
...
import 'package:smart_clinic_booking/features/medication/data/datasources/medication_remote_datasource.dart';
import 'package:smart_clinic_booking/features/medication/data/repositories/medication_repository_impl.dart';
import 'package:smart_clinic_booking/features/medication/domain/repositories/medication_repository.dart';
import 'package:smart_clinic_booking/features/medication/domain/usecases/get_medications_usecase.dart';

import 'package:smart_clinic_booking/features/profile/data/datasources/profile_remote_datasource.dart';
import 'package:smart_clinic_booking/features/profile/data/repositories/profile_repository_impl.dart';
...
import 'package:smart_clinic_booking/features/maps/data/repositories/maps_repository_impl.dart';
import 'package:smart_clinic_booking/features/maps/domain/repositories/maps_repository.dart';

import 'package:smart_clinic_booking/features/notification/data/datasources/notification_remote_datasource.dart';
import 'package:smart_clinic_booking/features/notification/data/repositories/notification_repository_impl.dart';
import 'package:smart_clinic_booking/features/notification/domain/repositories/notification_repository.dart';

import 'package:smart_clinic_booking/features/admission/data/datasources/admission_remote_datasource.dart';
import 'package:smart_clinic_booking/features/admission/data/repositories/admission_repository_impl.dart';
import 'package:smart_clinic_booking/features/admission/domain/repositories/admission_repository.dart';
...
import 'package:smart_clinic_booking/features/booking/domain/usecases/check_slot_availability_usecase.dart';
import 'package:smart_clinic_booking/features/booking/domain/usecases/lock_slot_usecase.dart';
import 'package:smart_clinic_booking/features/booking/domain/usecases/release_slot_lock_usecase.dart';
import 'package:smart_clinic_booking/features/booking/domain/usecases/confirm_booking_usecase.dart';
import 'package:smart_clinic_booking/features/booking/domain/usecases/join_waitlist_usecase.dart';
import 'package:smart_clinic_booking/features/booking/domain/usecases/reschedule_booking_usecase.dart';
import 'package:smart_clinic_booking/features/booking/domain/usecases/expire_stale_unpaid_bookings_usecase.dart';
