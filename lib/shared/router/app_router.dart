...
import 'package:smart_clinic_booking/features/clinical/presentation/screens/clinical_encounter_workflow_screen.dart';
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => ClinicalEncounterWorkflowScreen(
